        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <x-admin.table :headers="['#', 'Language', 'Name', 'Status', 'Actions']"></x-admin.table>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.hadith-chapter-translations.dataTable') }}",
                    data: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let url =
                                "{{ route('admin.hadith-chapter-translations.status', ':id') }}"
                                .replace(':id', row.id);
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            const url =
                                "{{ route('admin.hadith-chapter-translations.index', [$chapter->id, ':id']) }}"
                                .replace(':id', row.id);
